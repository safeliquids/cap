...
bool test_prefix_default_0() {
    ...
    cap_parser_add_flag(parser, foo, DT_PRESENCE, 0, -1);
    cap_parser_add_positional(parser, word, DT_STRING);
...
bool test_prefix_default_4() {
    ...
    cap_parser_add_flag(parser, foo, DT_PRESENCE, 0, -1);
    cap_parser_add_flag(parser, bar, DT_PRESENCE, 0, -1);
    cap_parser_add_positional(parser, word, DT_STRING);
    cap_parser_add_positional(parser, wordle, DT_STRING);
