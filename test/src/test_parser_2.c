...
bool test_one_positional_int() {
    ...
    cap_parser_add_positional(parser, name, DT_INT, NULL);
...
bool test_one_positional_double() {
    const char * name = "argument";
    ArgumentParser * parser = cap_parser_make_empty();
    cap_parser_add_positional(parser, name, DT_DOUBLE, NULL);
...
bool test_one_positional_string() {
    ...
    ArgumentParser * parser = cap_parser_make_empty();
    cap_parser_add_positional(parser, name, DT_STRING, NULL);
