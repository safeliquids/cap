...
bool test_parse_flag() {
    ...
    cap_parser_add_flag(parser, sus_flag, DT_PRESENCE, 0, 1);
...
bool test_parse_double_flag() {
    ...
    cap_parser_add_flag(parser, sus_flag, DT_DOUBLE, 0, 1);
...
bool test_parse_int_flag() {
    ...
    cap_parser_add_flag(parser, sus_flag, DT_INT, 0, 1);
...
bool test_parse_string_flag() {
    ...
    cap_parser_add_flag(parser, sus_flag, DT_STRING, 0, 1);
...
bool test_more_count_checking() {
    ...
    ArgumentParser * parser = cap_parser_make_empty();
    cap_parser_add_flag(parser, flag, DT_INT, lower_bound, upper_bound);
